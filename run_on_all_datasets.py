...
for dataset in DATASETS:
    ...
    unformatted_cmd = 'python3 main.py --data %s --mode train --model-file %s --algorithm %s'
    ...
    for subset in ['train', 'dev', 'test']:
        ...
        unformatted_cmd = 'python3 main.py --data %s --mode test --model-file %s --predictions-file %s'
